...
describe('frontend config', () => {
  ...
  it('ignores placeholder Stripe publishable keys', () => {
    expect(normalizeStripePublishableKey('your_stripe_publishable_key')).toBeUndefined()
    expect(normalizeStripePublishableKey(' pk_test_123 ')).toBe('pk_test_123')
  })
})
